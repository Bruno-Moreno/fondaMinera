...
Para el análisis de datos primero se estudiará cada una de las dimensiones por separado, tratando de visualizar ciertas caracterìsticas o tendencias presentes en los datos, para luego, en hitos posteriores, unificar la exploración general del dataset, buscando hallar una interpretación más clara.
