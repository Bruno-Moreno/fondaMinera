...
* **¿Existe alguna relación entre la calidad de las viviendas y la comuna/región/zona a la que pertenece?**

* **¿Cómo se relacionan los atributos de las viviendas con atributos de los ingresos y salud?**
...
library(readr)
library(tidyverse)
household_for_db <- read_csv("~/GitHub/fondaMinera/dataset/household_for_db.csv")
zone_id <- read_csv("~/GitHub/fondaMinera/dataset/ids_household/zone_id.csv")
water_source_id <- read_csv("~/GitHub/fondaMinera/dataset/ids_household/water_source_id.csv")
land_using_id <- read_csv("~/GitHub/fondaMinera/dataset/ids_household/land_using_id.csv")
comuna_ids <- read_csv("~/GitHub/fondaMinera/dataset/2017_06_27_comunas_datachile_fixed.csv")
walls_material_id <- read_csv("~/GitHub/fondaMinera/dataset/ids_household/walls_material_id.csv")
less_than_20_blocks_health_center_id <- read_csv("~/GitHub/fondaMinera/dataset/ids_household/less_than_20_blocks_health_center_id.csv")
less_than_20_blocks_educational_center_id <- read_csv("~/GitHub/fondaMinera/dataset/ids_household/less_than_20_blocks_educational_center_id.csv")
less_than_8_blocks_public_transport_id <- read_csv("~/GitHub/fondaMinera/dataset/ids_household/less_than_8_blocks_public_transport_id.csv")
paying_credit_id <- read_csv("~/GitHub/fondaMinera/dataset/ids_household/paying_credit_id.csv")
household_sq_meters_id <- read_csv("~/GitHub/fondaMinera/dataset/ids_household/household_sq_meters_id.csv")
water_distribution_id <- read_csv("~/GitHub/fondaMinera/dataset/ids_household/water_distribution_id.csv")
subsidy_or_program_id <- read_csv("~/GitHub/fondaMinera/dataset/ids_household/subsidy_or_program_id.csv")
```
```{r}
...
#Cantidad de datos que ofrecen las diferentes comunas
totalQ <- sum(sistema_bancario$comuna_name == 'Quilicura') #
totalPA <- sum(sistema_bancario$comuna_name == 'Puente Alto') #
totalL <- sum(sistema_bancario$comuna_name == 'Laja') #
totalLC <- sum(sistema_bancario$comuna_name == 'Las Condes') #

#Cantidad de datos que ofrecen las diferentes regiones
totalValpo <- sum(sistema_bancario$region_name == 'Valparaíso') #
totalRM <- sum(sistema_bancario$region_name == 'Región Metropolitana Santiago') #
totalM <- sum(sistema_bancario$region_name == 'Maule') #
totalBB <- sum(sistema_bancario$region_name == 'Bío Bío') #
```
