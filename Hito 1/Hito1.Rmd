...
Para este proyecto trabajaremos con la base de datos dispuesta por CASEN y recuperada de [datachile.io](https://es.datachile.io/about/data). El objetivo de este proyecto será estudiar esta base de datos y extraer información útil acerca del contexto nacional y su evolución a lo largo de los años en los ámbitos de ingresos, vivienda, salud y datos bancarios. Para esto y utilizando herramientas de minería de datos intentaremos caracterizar grupos socioeconómicos en base a estas dimensiones y evidenciar la deficiente distribución de riquezas en el país.



# Exploración de Datos

Para el análisis de datos primero estudiaremos cada una de las dimensiones por separado, tratando de visualizar ciertas caracterìsticas o tendencias presentes en los datos, para luego, en hitos posteriores, unificar la exploración general del dataset, buscando hallar una interpretación más clara.

* Preprocesamiento necesario
* Dimension, algunos estadísticos importantes 
* descripción de los parámetros (columnas) consideradas
* laja vs quilicura vs puente alto vs las condes 
* region metropolitana, biobio, valpo , Maule 
